...
public class MSHWebserviceConfiguration {
    ...
    public Endpoint msh(DomibusBus domibusBus,
                        ...
                        DomibusOutInterceptorExtensionManager domibusOutInterceptorExtensionManager,
        ...
        endpoint.setInInterceptors(Arrays.asList(domibusInInterceptorExtensionManager, domibusReadyInterceptor, setDomainInInterceptor, trustSenderInterceptor, setPolicyInServerInterceptor, propertyValueExchangeInterceptor, httpHeaderInInterceptor));
        endpoint.setOutInterceptors(Arrays.asList(clearMDCInterceptor, setPolicyOutInterceptorServer, saveRawPulledMessageInterceptor, httpHeaderOutInterceptor,domibusOutInterceptorExtensionManager ));
