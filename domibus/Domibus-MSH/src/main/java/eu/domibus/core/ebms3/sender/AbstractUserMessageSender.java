...
public abstract class AbstractUserMessageSender implements MessageSender {
    ...
    public void sendMessage(final Messaging messaging, final UserMessageLog userMessageLog) {
        ...
        try {
            ...
            saveRequest(requestSoapMessage, userMessage);
    ...
    /**
     * Save raw timestamped outgoing message
     * @param request
     * @param userMessage
     */
    public void saveRequest(SOAPMessage request, UserMessage userMessage) {
        ...
        try {
            ...
            getLog().debug("Persist raw XML envelope: " + rawXMLMessage);
            ...
            getLog().warn("Unable to log the raw message XML due to: ", e);
        }
    }
