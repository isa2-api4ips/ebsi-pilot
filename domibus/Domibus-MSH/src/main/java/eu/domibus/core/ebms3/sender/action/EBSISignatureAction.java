...
package eu.domibus.core.ebms3.sender.action;
...
/**
 * EBSI pilot sandbox test to override signature action with purpose of  enhancing signature with the timestampe
 *  (testing with not policy configuration!)
 */
@Deprecated
public class EBSISignatureAction implements Action {
    public static DomibusLogger LOG  = DomibusLoggerFactory.getLogger(EBSISignatureAction.class);

    public void execute(WSHandler handler, SecurityActionToken actionToken, RequestData reqData)
            throws WSSecurityException {
        LOG.info("Excecute signature");
        ...
        try {
            ...
            LOG.info("//////////////////////////////////////////////////////////////////");
            String outputString =
                    XMLUtils.prettyDocumentToString(wsSign.getSignatureElement().getOwnerDocument());
