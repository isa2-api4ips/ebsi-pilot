 ...
 */
@Service
public class InterceptorExtensionChangeListener implements DomibusPropertyChangeListener {
    ...
    public boolean handlesProperty(String propertyName) {
        return StringUtils.equalsIgnoreCase(propertyName, DOMIBUS_EXTENSION_INTERCEPTOR_OUT_CLASSES);
    }
