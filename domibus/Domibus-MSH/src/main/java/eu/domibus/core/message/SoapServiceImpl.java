...
public class SoapServiceImpl implements SoapService {
    ...
    public String getSoapEnvelopeAsRAWXml(final String messageId) {
        RawEnvelopeDto rawEnvelopeLogDto = rawEnvelopeLogDao.findRawXmlByMessageId(messageId);
        return rawEnvelopeLogDto == null? null: rawEnvelopeLogDto.getRawMessage();
    }
